	...
	<view>
		...
		<block v-if="TabCur==0">
			<view class="cu-card article"> <!-- no-card -->
				<view class="cu-item shadow" @tap="toChild" :data-url="'/pages/fwsc/show'">
		...
		<block v-if="TabCur==2">
			<view class="cu-card article"> <!-- no-card -->
				<view class="cu-item shadow">
					<view class="title"><view class="text-cut">2无意者 烈火焚身;以正义的烈火拔出黑暗。我有自己的正义，见证至高的烈火吧。</view></view>
					<view class="content">
						<image src="https://ossweb-img.qq.com/images/lol/web201310/skin/big10006.jpg"
						 mode="aspectFill"></image>
						<view class="desc">
