	...
	<view>
		...
		<block v-if="TabCur==0">
			<view class="cu-card article"> <!-- no-card -->
				<view class="cu-item">
					...
					<view class="content">
						<view class="desc">
							...
							<view>
								<text class="cuIcon-countdown text-blue margin-right-xs">提交于:2020-04-28</text>
							</view>
						</view>
					</view>
				</view>
				...
				<view class="cu-item">
					<view class="title"><view class="text-cut">需求名称</view></view>
					<view class="content">
						<view class="desc">
							<view class="text-content"> 需求描述*********</view>
							<view>
		...
		<block v-if="TabCur==1">
			<view class="cu-card article"> <!-- no-card -->
				<view class="cu-item">
					<view class="title"><view class="text-cut">需求名称1</view></view>
					<view class="content">
						<view class="desc">
							<view class="text-content">需求描述</view>
							<view>
